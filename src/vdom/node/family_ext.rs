...
use crate::vdom::phase::{Indexed, PhaseData, Processed, Raw};
...
impl<P: PhaseData> FamilyExt<P> {
    ...
    pub fn kind(&self) -> crate::vdom::family::FamilyKind {
        use crate::vdom::family::FamilyKind;
        match self {
...
impl FamilyExt<Indexed> {
    ...
    pub fn stable_id(&self) -> crate::vdom::id::StableId {
        match self {
